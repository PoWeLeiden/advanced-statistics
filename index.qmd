...
|------------------------|------------------------|------------------------|
| 1 | Lineaire Modellen | @sec-linear-covcor ; @sec-reporting-and-presenting-results (8.2 & 8.3) |
| 2 | Lineaire Modellen | @sec-binary-predictors ; @sec-statistical-significance ; @sec-predicted-residual-values (5.1 & 5.2) ; @sec-reporting-and-presenting-results (8.4) |
| 3 | Lineaire Modellen | @sec-multiple-linear-regression ; @sec-predicted-residual-values (5.3) ; @sec-model-fit ; @sec-reporting-and-presenting-results (8.4 - 8.7) |
